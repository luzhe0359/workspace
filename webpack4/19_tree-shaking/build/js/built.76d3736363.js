...
/* harmony export */   "ful": () => (/* binding */ ful)
/* harmony export */ });
function ful(x, y) {
  return x * y;
}
...
console.log((0,_test__WEBPACK_IMPORTED_MODULE_2__.ful)(9, 9));
console.log('index.js 文件被加载~~~'); // 什么都不配置，无法解析const、箭头函数等

(0,_print__WEBPACK_IMPORTED_MODULE_3__["default"])();
...
/******/ })()
;
//# sourceMappingURL=built.76d3736363.js.map